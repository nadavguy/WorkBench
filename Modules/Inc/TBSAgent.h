...
typedef enum {NOPLATFORM, M200, M300, M600, PHANTOM, MAVIC, SAFEAIR, TAILID, PHANTOMEU, MAVICEU, M30, M350} PLATFORMName;

typedef enum {MULTICOPTER, VTOLHORIZONTAL, VTOLTRANSITION, VTOLVERTICAL} PLATFORMType;

typedef enum {PREINIT, IDLE, ARMED, TRIGGERED, UNKNOWN, MAINTENANCE, AUTOCALIBRATION, TESTFLIGHT, INIT, OPERATIONAL, UPDATE} SYSTEMState;
