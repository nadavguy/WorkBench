...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PA4 PA8 PA10 PA11
                           PA12 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_4|GPIO_PIN_8|GPIO_PIN_10|GPIO_PIN_11
  ...
  GPIO_InitStruct.Pin = GPIO_ChargeDetect_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIO_ChargeDetect_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = GPIO_Buzzer_Pin|GPIO_ChargeEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
